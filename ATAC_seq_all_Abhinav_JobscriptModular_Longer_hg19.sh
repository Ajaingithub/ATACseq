#!/bin/bash
#$ -cwd
#$ -o '/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/tohg19/sbatch/qsub_output'
#$ -l h_vmem=16G
#$ -pe threaded 4
#$ -q 1-day
...
myDATADIR="/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/Batch18_YF"
...
myigvDIR="/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/tools/IGV_2.12.3"
...
bowtieCMD="/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/miniconda3/bin/bowtie2 --no-discordant --no-dovetail --no-mixed --no-unal --very-sensitive -X 2000 -p 25 -x /research/labs/immunology/goronzy_weyand/GoronzyLab_SCG/RefGenomes/H_sapiens/hg19/indexes/bowtie2/hg19 --rg-id ${jobSample} -1 ${tempRead1} -2 ${tempRead2} -S ${myPROJDIR}/Analysis/bowtie/${jobSample}/${jobSample}.sam"
echo ${bowtieCMD}
eval ${bowtieCMD}
}
...
samtobamCMD="samtools view -q 20 -uT /research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Resources/Homo_sapiens/UCSC/hg19.fa ${myBowtieDir}/${jobSample}.sam -o ${myQCDIR}/${jobSample}.bam"
echo ${samtobamCMD}
eval ${samtobamCMD}
...
bamtobedgraphCMD="genomeCoverageBed -bg -split -ibam ${myQCDIR}/${jobSample}.rmdup.sorted.bam -trackopts 'type=bedGraph name='${jobSample} -g /research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Resources/Homo_sapiens/UCSC/hg19.fa.fai > ${myQCDIR}/${jobSample}.rmdup.bedGraph"
echo ${bamtobedgraphCMD}
eval ${bamtobedgraphCMD}

# convert to tdf
bamtotdf="${myigvDIR}/igvtools count ${myQCDIR}/${jobSample}.rmdup.sorted.bam ${myQCDIR}/${jobSample}.rmdup.tdf /research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Resources/Homo_sapiens/UCSC/hg19.fa.fai"
echo ${bamtotdf}
eval ${bamtotdf}
